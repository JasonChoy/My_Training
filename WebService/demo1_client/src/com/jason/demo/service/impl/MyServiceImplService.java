 ...
 * 
 */
@WebServiceClient(name = "MyServiceImplService", targetNamespace = "http://impl.service.demo.jason.com/", wsdlLocation = "http://localhost:8888/ws?wsdl")
    ...
    extends Service
{
    ...
    private final static QName MYSERVICEIMPLSERVICE_QNAME = new QName("http://impl.service.demo.jason.com/", "MyServiceImplService");
    ...
    public IMyService getMyServiceImplPort() {
        return super.getPort(new QName("http://impl.service.demo.jason.com/", "MyServiceImplPort"), IMyService.class);
    }
    ...
    public IMyService getMyServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://impl.service.demo.jason.com/", "MyServiceImplPort"), IMyService.class, features);
    }
